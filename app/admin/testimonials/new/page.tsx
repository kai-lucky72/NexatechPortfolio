  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">New Testimonial</h1>
          <p className="text-muted-foreground mt-2">Add a new customer testimonial</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            type="submit"
            disabled={loading || !formData.testimonial || !formData.client_name || !formData.client_role || !formData.client_company}
